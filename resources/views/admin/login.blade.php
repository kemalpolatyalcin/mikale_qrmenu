...
<body class="bg-[#F9F8F3] min-h-screen flex flex-col font-poppins">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-6 py-2 flex justify-around items-center z-40 shadow-lg">
        <a href="{{ url('/') }}" class="flex flex-col items-center gap-1 text-gray-500 hover:text-[#8C6C47] transition-colors w-1/3">
            <i class="fa-solid fa-house text-lg mb-0.5"></i><span class="text-xs" data-i18n="navHome">Ana Sayfa</span>
        </a>
        <a href="{{ url('/') }}" class="flex flex-col items-center gap-1 text-gray-500 hover:text-[#8C6C47] transition-colors w-1/3">
            <i class="fa-solid fa-magnifying-glass text-lg mb-0.5"></i><span class="text-xs" data-i18n="navSearch">Menü</span>
        </a>
        <a href="{{ url('/admin') }}" class="flex flex-col items-center gap-1 text-[#8C6C47] hover:text-[#8C6C47] transition-colors w-1/3 font-semibold">
            <i class="fa-solid fa-user-lock text-lg mb-0.5"></i><span class="text-xs">Admin</span>
        </a>
    </nav>
